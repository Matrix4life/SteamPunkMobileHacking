...
const MODE_COMMANDS = {
  ...
  'WIFI HACKING': {
    ...
    field: [
      ...
      { cmd: 'airodump-ng focus', desc: 'Focus capture on target BSSID' },
  ...
  'ECONOMY & ITEMS': {
    arcade: [
      ...
      { cmd: 'market', desc: 'Open black market' },
    ...
    field: [
      ...
      { cmd: 'market', desc: 'Black market trading' },
    ...
    operator: [
      ...
      { cmd: 'market', desc: 'Access commodity exchange' },
